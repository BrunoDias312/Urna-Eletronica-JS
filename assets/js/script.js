...
//Verifica e atribui qual botao foi clicado
function clicou(n){
...
function branco(){
    ...
    //alert("Tem que ter os digito em branco! clique em corrigir e entao em branco novamente!")
...
function confirma(){
    ...
    if(votoBranco === true){
        ...
        console.log("Confirmando com Branco");
